...
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer v1.5.4 Author: CyberboyHacker (Github/IG)   \e[0m\n"
printf "\n"
}
...
[*] User-Agent:  User-Agent: Mozilla/5.0 (Linux; Android 8.0.0; unknown device) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.127 Mobile Safari/537.36
